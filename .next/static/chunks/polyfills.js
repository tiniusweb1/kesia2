!(function () {
                ...
                (g &&
                    ...
                    $e !== Object.prototype &&
                        ...
                        (Ue(u) !== $e &&
                            (Ge
                                ? Ge(u, $e)
                                : 'function' != typeof u[He] && T(u, He, Qe)),
                        Be(u, l, !0))),
                o == Ye &&
                    d &&
                    d.name !== Ye &&
        ...
        Gn = function (t) {
            return function (e) {
                for (
                    ...
                    (r = o[u++]),
                        (i && !Kn.call(n, r)) || s.push(t ? [r, n[r]] : n[r])
                return s
            }
        },
        ...
        return [
            ...
            function (t, n) {
                ...
                for (var d = []; ; ) {
                    ...
                    if ((d.push(v), !h)) break
                    '' === String(v[0]) &&
                        (c.lastIndex = zi(f, ft(c.lastIndex), p))
                }
        ...
        Di('search', 1, function (t, e, r) {
            return [
                ...
                function (t) {
                    ...
                    var u = Wi(o, i)
                    return (
                        Xn(o.lastIndex, a) || (o.lastIndex = a),
                        null === u ? -1 : u.index
                    )
                },
            ]
    ...
    var va = wt.f,
        ...
        Ka = function (t, e) {
            var r = (Na[t] = Jt(Ta[Oa]))
            return (
                ja(r, { type: Aa, tag: t, description: e }),
                i || (r.description = e),
                r
            )
        },
    ...
    if (
        (Nt ||
            ((Ta = function () {
                ...
                return (
                    i && za && Wa(Ia, e, { configurable: !0, set: r }), Ka(e, t)
                )
            }),
    ...
    var su,
        ...
        vu = lu('endsWith'),
        gu = !(
            vu || ((su = hu(String.prototype, 'endsWith')), !su || su.writable)
        )
    Lt(
    ...
    var bu =
        ...
        Su = function (t) {
            return function (e, r, n) {
                ...
                return c <= u || '' == s
                    ? a
                    : ((i = bu.call(s, wu((o = c - u) / s.length))).length >
                          o && (i = i.slice(0, o)),
                      t ? a + i : i + a)
            }
        },
                ...
                if (y(c))
                    if ('function' == typeof (t = vr(c)))
                        for (
                            ...
                            if (
                                (a = (i = (o = cn(j(n.value))).next).call(o))
                                    .done ||
                                (u = i.call(o)).done ||
                                !i.call(o).done
                            )
    ...
    zr(
        ws,
        {
            ...
            delete: function (t) {
                ...
                for (
                    var e = os(this), r = e.entries, n = t + '', o = 0;
                    o < r.length;
        ...
        (i &&
            Wt(kc, {
                ...
                port: Kc(Bc, function (t) {
                    var e = Ps(this)
                    nc(e) ||
                        ('' == (t = String(t)) ? (e.port = null) : Ic(e, t, wc))
                }),
    ...
    var hl = et.set,
        ...
        dl = function (t, e) {
            ...
            return (
                Fr(t, n.push, n),
                i
                    ? hl(r, { errors: n, type: 'AggregateError' })
                    : (r.errors = n),
    ...
    if (wl)
        var Sl = [
            ...
            El =
                ...
                function (t) {
                    return (
                        t && Sl.indexOf(Object.prototype.toString.call(t)) > -1
                    )
                }
    function xl(t) {
        if (
